...
#### Цель разработки: реализация расчета на прочность изгибаемых элементов сплошного сечения по формуле
#### 43 СП 16.13330.2017 с учетом бимомента (буквенное обозначение - B, см. рис.)
