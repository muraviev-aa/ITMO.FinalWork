...
public class BeamDialogI extends JFrame implements Bimoment, SectionI {
    ...
    private JCheckBox default30SH1CheckBox;
    ...
    public BeamDialogI() {
        ...
        helpButton1.addActionListener(e -> {
            ...
            JLabel image = new JLabel(new ImageIcon("src/main/resources/norm_dvs.png"),
        ...
        helpButton.addActionListener(e -> {
            JDialog dialog = createDialog();
            JLabel image = new JLabel(new ImageIcon("src/main/resources/dv_sim.png"),
                    SwingConstants.CENTER);
            Border softBevelLowered = BorderFactory.
                    createSoftBevelBorder(BevelBorder.LOWERED);
            image.setBorder(softBevelLowered);
    ...
    public void actionSolution() {
        ...
        wx = Double.parseDouble(textField5.getText());
    ...
    public void seeTable() throws Exception {
        ...
        ResultSet rs = st.executeQuery("SELECT * FROM profiles.dvpr");
        ...
        SwingUtilities.invokeLater(
                () -> {
                    ...
                    JFrame frame = new JFrame("Двутавр с параллельными гранями полок");
